...
public class TextViewActivityTest
{
    ...
    {
        TextView enter = (TextView) activity.findViewById(R.id.enter_your);
    ...
    {
        TextView previous = (TextView) activity.findViewById(R.id.previous);
    ...
    {
        TextView average = (TextView) activity.findViewById(R.id.average);
