...
public class TanitaDataTable {
	...
	private static String getTanitaDataTable() {
		...
		sql.append(COLUMN_BODY_FAT_TOTAL).append(" integer not null, ");
		sql.append(COLUMN_BODY_FAT_LEFT_ARM).append(" integer not null, ");
		sql.append(COLUMN_BODY_FAT_RIGHT_ARM).append(" integer not null, ");
		sql.append(COLUMN_BODY_FAT_RIGHT_LEFT).append(" integer not null, ");
		sql.append(COLUMN_BODY_FAT_LEFT_LEG).append(" integer not null, ");
		sql.append(COLUMN_BODY_FAT_TRUNK).append(" integer not null, ");
		sql.append(COLUMN_MUSCLE_MASS_TOTAL).append(" integer not null, ");
		sql.append(COLUMN_MUSCLE_MASS_LEFT_ARM).append(" integer not null, ");
		sql.append(COLUMN_MUSCLE_MASS_RIGHT_ARM).append(" integer not null, ");
		sql.append(COLUMN_MUSCLE_MASS_RIGHT_LEG).append(" integer not null, ");
		sql.append(COLUMN_MUSCLE_MASS_LEFT_LEG).append(" integer not null, ");
		sql.append(COLUMN_MUSCLE_MASS_TRUNK).append(" integer not null, ");
		sql.append(COLUMN_PHYSIC_RATING).append(" integer not null, ");
		sql.append(COLUMN_WEIGHT).append(" integer not null, ");
		sql.append(COLUMN_DAILY_CALORIC_INTAKE).append(" integer not null, ");
		sql.append(COLUMN_DAILY_METABOLIC_AGE).append(" integer not null, ");
		sql.append(COLUMN_BODY_WATER_PERCENTAGE).append(" integer not null, ");
		sql.append(COLUMN_VISCERAL_FAT).append(" integer not null, ");
		sql.append(COLUMN_BONE_MASS).append(" integer not null, ");
