...
public class MuscleMassLeftArmActivityTest {
	...
	public void testGetLayoutResID() {
		assertThat(activity.getResourceIDForLayout(), is(R.layout.muscle_mass_left_arm));
	}

	@Test
	public void testGetColumnName() {
		assertThat(activity.getColumnName(), is(TanitaDataTable.Column.MUSCLE_MASS_LEFT_ARM));
	}

	@Test
	public void testGetNextClass() {
		assertThat(activity.getNextClass().toString(), is(MuscleMassRightArmActivity.class.toString()));
	}
}
